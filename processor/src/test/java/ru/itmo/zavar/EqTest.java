...
public class EqTest {
    @Test
    public void testEq() {
        System.out.println("Testing EQ instruction...");
        ...
        program.add(InstructionCode.EQ.getBinary().longValue() << 24);
        ...
        Assertions.assertEquals(0, controlUnit.getTickLog().get(21).tos());
