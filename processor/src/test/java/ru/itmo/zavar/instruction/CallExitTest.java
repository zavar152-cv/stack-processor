...
public class CallExitTest {
    ...
    public void testCall() {
        ...
        program.add((InstructionCode.LIT.getBinary().longValue() << 24) + 5); // 8
    ...
    public void testNestedCall() {
        ...
        List<Long> dataMemory = Arrays.asList(0L, 0L, 0L, 15L, 15L, 66L, 89L);
        ...
        program.add((InstructionCode.LIT.getBinary().longValue() << 24) + 6); // 14
