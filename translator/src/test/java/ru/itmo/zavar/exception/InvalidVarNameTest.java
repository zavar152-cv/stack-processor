...
public class InvalidVarNameTest {

    @Test
    public void invalidVarNameTest() throws URISyntaxException, IOException {
        System.out.println("Test for invalid var name...");
        URL srcUrl = getClass().getClassLoader().getResource("invalidVarName.zorth"); // path for source code
        assert srcUrl != null;
