...
| ------ | ------ | ------ | ------ |
| HALT | 00000000 | cell | Останов |
| ADD | 00000010 | cell | см. язык |
| SUB | 00000100 | cell | см. язык |
| MUL | 00000110 | cell | см. язык |
| DIV | 00001000 | cell | см. язык |
| AND | 00001010 | cell | см. язык |
| OR | 00001100 | cell | см. язык |
| NEG | 00001110 | cell | см. язык |
| XOR | 00010000 | cell | см. язык |
| EQ | 00010010 | cell | см. язык (=) |
| GR | 00010100 | cell | см. язык (>) |
| LE | 00010110 | cell | см. язык (<) |
| DROP | 00011000 | cell | см. язык |
| DUP | 00011010 | cell | см. язык |
| OVER | 00011110 | cell | см. язык |
| SWAP | 00100000 | cell | см. язык |
| >R | 00100010 | cell | Поместить веришну DS на RS |
| R> | 00100100 | cell | Поместить веришну RS на DS |
| ! | 00100110 | cell | см. язык |
| @ | 00101000 | cell | см. язык |
| [LIT] addr | 00101011 | cell | Загрузить литерал на вершину по адресу |
| [JMP] addr | 00101101 | cell | Безусловный переход по адресу |
| [IF] addr | 00101111 | cell | Переход по адресу, если на вершине 0 |
| [CALL] addr | 00110001 | cell | Вывзов функции по адресу |
| [LOOP] addr | 00110011 | cell | Переход по адресу пока на вершине не 0 |
| NOPE | 00110100 | cell | Нет операции |
| EXIT | 00110110 | cell | см. язык |
| NOT | 00111000 | cell | см. язык |
| [ADDR] addr | 00111011 | cell | Загрузить адрес в AR |
| INC | 00111100 | cell | см. язык |
| DEC | 00111110 | cell | см. язык |
| NEQ | 01000000 | cell | см. язык |
